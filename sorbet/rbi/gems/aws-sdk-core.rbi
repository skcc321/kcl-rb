...
class InvalidName___Class_0x00___CodeLiteral_1 < String
  def inspect; end
end
...
module Aws::Json::OjEngine
  def self.detect_oj_parse_errors; end
  def self.dump(value); end
  def self.load(json); end
end
...
class Aws::STS::Types::AssumeRoleRequest < Anonymous_Struct_2
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleResponse < Anonymous_Struct_3
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLRequest < Anonymous_Struct_4
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithSAMLResponse < Anonymous_Struct_5
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityRequest < Anonymous_Struct_6
  include Aws::Structure
end
...
class Aws::STS::Types::AssumeRoleWithWebIdentityResponse < Anonymous_Struct_7
  include Aws::Structure
end
...
class Aws::STS::Types::AssumedRoleUser < Anonymous_Struct_8
  include Aws::Structure
end
...
class Aws::STS::Types::Credentials < Anonymous_Struct_9
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageRequest < Anonymous_Struct_10
  include Aws::Structure
end
...
class Aws::STS::Types::DecodeAuthorizationMessageResponse < Anonymous_Struct_11
  include Aws::Structure
end
...
class Aws::STS::Types::ExpiredTokenException < Anonymous_Struct_12
  include Aws::Structure
end
...
class Aws::STS::Types::FederatedUser < Anonymous_Struct_13
  include Aws::Structure
end
...
class Aws::STS::Types::GetAccessKeyInfoRequest < Anonymous_Struct_14
  include Aws::Structure
end
...
class Aws::STS::Types::GetAccessKeyInfoResponse < Anonymous_Struct_15
  include Aws::Structure
end
...
class Aws::STS::Types::GetCallerIdentityResponse < Anonymous_Struct_16
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenRequest < Anonymous_Struct_17
  include Aws::Structure
end
...
class Aws::STS::Types::GetFederationTokenResponse < Anonymous_Struct_18
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenRequest < Anonymous_Struct_19
  include Aws::Structure
end
...
class Aws::STS::Types::GetSessionTokenResponse < Anonymous_Struct_20
  include Aws::Structure
end
...
class Aws::STS::Types::IDPCommunicationErrorException < Anonymous_Struct_21
  include Aws::Structure
end
...
class Aws::STS::Types::IDPRejectedClaimException < Anonymous_Struct_22
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidAuthorizationMessageException < Anonymous_Struct_23
  include Aws::Structure
end
...
class Aws::STS::Types::InvalidIdentityTokenException < Anonymous_Struct_24
  include Aws::Structure
end
...
class Aws::STS::Types::MalformedPolicyDocumentException < Anonymous_Struct_25
  include Aws::Structure
end
...
class Aws::STS::Types::PackedPolicyTooLargeException < Anonymous_Struct_26
  include Aws::Structure
end
...
class Aws::STS::Types::PolicyDescriptorType < Anonymous_Struct_27
  include Aws::Structure
end
...
class Aws::STS::Types::RegionDisabledException < Anonymous_Struct_28
  include Aws::Structure
end
...
class Aws::STS::Types::Tag < Anonymous_Struct_29
  include Aws::Structure
end
...
class Aws::SSO::Types::AccountInfo < Anonymous_Struct_31
  include Aws::Structure
end
...
class Aws::SSO::Types::GetRoleCredentialsRequest < Anonymous_Struct_32
  include Aws::Structure
end
...
class Aws::SSO::Types::GetRoleCredentialsResponse < Anonymous_Struct_33
  include Aws::Structure
end
...
class Aws::SSO::Types::InvalidRequestException < Anonymous_Struct_34
  include Aws::Structure
end
...
class Aws::SSO::Types::ListAccountRolesRequest < Anonymous_Struct_35
  include Aws::Structure
end
...
class Aws::SSO::Types::ListAccountRolesResponse < Anonymous_Struct_36
  include Aws::Structure
end
...
class Aws::SSO::Types::ListAccountsRequest < Anonymous_Struct_37
  include Aws::Structure
end
...
class Aws::SSO::Types::ListAccountsResponse < Anonymous_Struct_38
  include Aws::Structure
end
...
class Aws::SSO::Types::LogoutRequest < Anonymous_Struct_39
  include Aws::Structure
end
...
class Aws::SSO::Types::ResourceNotFoundException < Anonymous_Struct_40
  include Aws::Structure
end
...
class Aws::SSO::Types::RoleCredentials < Anonymous_Struct_41
  include Aws::Structure
end
...
class Aws::SSO::Types::RoleInfo < Anonymous_Struct_42
  include Aws::Structure
end
...
class Aws::SSO::Types::TooManyRequestsException < Anonymous_Struct_43
  include Aws::Structure
end
...
class Aws::SSO::Types::UnauthorizedException < Anonymous_Struct_44
  include Aws::Structure
end
...
class Aws::Plugins::InvocationId::Handler < Seahorse::Client::Handler
  def apply_invocation_id(context); end
  def call(context); end
end
